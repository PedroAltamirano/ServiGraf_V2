...
@php
  ...
  if($cnt = count(old('tipo_refer') ?? [])) {
    for($i = 0; $i < $cnt; $i++){
      ...
      $model->inicio_laboral_refer = old('inicio_laboral_refer')[$i];
      $model->fin_laboral_refer = old('fin_laboral_refer')[$i];
...
<script>
  ...
  const add_referencia = (tipo_refer_val=null, empresa_val=null, contacto_val=null, telefono_refer_val=null, afinidad_val=null, inicio_laboral_refer_val=null, fin_laboral_refer_val=null, cargo_refer_val=null, razon_separacion_val=null) => {
    ...
    let inicio_laboral = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'inicio_laboral_refer[]', 'id': `inicio_laboral_refer_${index_referencia}`, 'value': inicio_laboral_refer_val});

    let fin_laboral = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'fin_laboral_refer[]', 'id': `fin_laboral_refer_${index_referencia}`, 'value': fin_laboral_refer_val});
  ...
  if(old_refs != []){
    old_refs.map(item => {
      console.log(item);
      add_referencia(item.tipo_refer, item.empresa, item.contacto, item.telefono_refer, item.afinidad, item.inicio_laboral_refer, item.fin_laboral_refer, item.cargo_refer, item.razon_separacion);
    });
  }
