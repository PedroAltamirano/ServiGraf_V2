        ...
        <div class="form-row col-12 col-md-10">
          ...
          <div class="form-group col-12 col-md-2">
            ...
            <select class="form-control form-control-sm @error('estado_civil') is-invalid @enderror" name="estado_civil" id="estado_civil" data-tags="true">
              ...
              <option value="{{ $key }}" {{ old('estado_civil', $nomina->estado_civil) == $key ? 'selected' : '' }}>{{ $value }}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group col-12 col-md-2">
            ...
            <select class="form-control form-control-sm @error('genero') is-invalid @enderror" name="genero" id="genero" data-tags="true">
              ...
              <option value="{{ $key }}" {{ old('genero', $nomina->genero) == $key ? 'selected' : '' }}>{{ $value }}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group col-12 col-md-2">
    ...
    <section id="documento">
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('aviso_entrada') is-invalid @enderror" id="aviso_entrada" name="aviso_entrada" {{ old('aviso_entrada', $docs->aviso_entrada) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('contrato_trabajo') is-invalid @enderror" id="contrato_trabajo" name="contrato_trabajo" {{ old('contrato_trabajo', $docs->contrato_trabajo) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('solicitud_empleo') is-invalid @enderror" id="solicitud_empleo" name="solicitud_empleo" {{ old('solicitud_empleo', $docs->solicitud_empleo) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('curriculum_vitae') is-invalid @enderror" id="curriculum_vitae" name="curriculum_vitae" {{ old('curriculum_vitae', $docs->curriculum_vitae) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('cedula_identidad') is-invalid @enderror" id="cedula_identidad" name="cedula_identidad" {{ old('cedula_identidad', $docs->cedula_identidad) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('papeleta_votacion') is-invalid @enderror" id="papeleta_votacion" name="papeleta_votacion" {{ old('papeleta_votacion', $docs->papeleta_votacion) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('record_policial') is-invalid @enderror" id="record_policial" name="record_policial" {{ old('record_policial', $docs->record_policial) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('libreta_militar') is-invalid @enderror" id="libreta_militar" name="libreta_militar" {{ old('libreta_militar', $docs->libreta_militar) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('certificado_escolar') is-invalid @enderror" id="certificado_escolar" name="certificado_escolar" {{ old('certificado_escolar', $docs->certificado_escolar) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('certificado_colegio') is-invalid @enderror" id="certificado_colegio" name="certificado_colegio" {{ old('certificado_colegio', $docs->certificado_colegio) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('certificado_universitario') is-invalid @enderror" id="certificado_universitario" name="certificado_universitario" {{ old('certificado_universitario', $docs->certificado_universitario) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('certificado_otros') is-invalid @enderror" id="certificado_otros" name="certificado_otros" {{ old('certificado_otros', $docs->certificado_otros) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('referencia_empleos') is-invalid @enderror" id="referencia_empleos" name="referencia_empleos" {{ old('referencia_empleos', $docs->referencia_empleos) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('referencia_personales') is-invalid @enderror" id="referencia_personales" name="referencia_personales" {{ old('referencia_personales', $docs->referencia_personales) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('certificado_medico') is-invalid @enderror" id="certificado_medico" name="certificado_medico" {{ old('certificado_medico', $docs->certificado_medico) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('aviso_salida') is-invalid @enderror" id="aviso_salida" name="aviso_salida" {{ old('aviso_salida', $docs->aviso_salida) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('acta_finiquito') is-invalid @enderror" id="acta_finiquito" name="acta_finiquito" {{ old('acta_finiquito', $docs->acta_finiquito) == '1' ? 'checked':'' }} value='1'>
        ...
        <div class="form-group col-12 col-md-2 text-center">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('recibo_pago_acta_fini') is-invalid @enderror" id="recibo_pago_acta_fini" name="recibo_pago_acta_fini" {{ old('recibo_pago_acta_fini', $docs->recibo_pago_acta_fini) == '1' ? 'checked':'' }} value='1'>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-12 col-md-2">
          ...
          <select class="form-control form-control-sm @error('tipo_sangre') is-invalid @enderror" name="tipo_sangre" id="tipo_sangre" data-tags="true">
            ...
            <option value="{{ $key }}" {{ old('tipo_sangre', $nomina->tipo_sangre) == $key ? 'selected' : '' }}>{{ $value }}</option>
            @endforeach
          </select>
        </div>
        <div class="form-group col-12 col-md-5">
...
<script>
  ...
  const add_educacion = (nivel_val=null, institucion_val=null, desde_val=null, hasta_val=null, titulo_val=null) => {
    ...
    let nivel = $('<select />', {'class': 'form-control form-control-sm', 'name': 'nivel_educ[]', 'id': `nivel_educ_${index_educacion}`}).append(niveles);
    if(nivel_val) nivel.val(nivel_val);

    let institucion = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'nombre_institucion[]', 'id': `nombre_institucion_${index_educacion}`, 'value': institucion_val});

    let desde = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'inicio[]', 'id': `inicio_${index_educacion}`, 'value': desde_val});

    let hasta = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'fin[]', 'id': `fin_${index_educacion}`, 'value': hasta_val});

    let titulo = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'titulo[]', 'id': `titulo_${index_educacion}`, 'value': titulo_val});
  ...
  const add_referencia = (tipo_refer_val=null, empresa_val=null, contacto_val=null, telefono_refer_val=null, afinidad_val=null, inicio_labor_refer_val=null, fin_labor_refer_val=null, cargo_refer_val=null, razon_separacion_val=null) => {
    ...
    let tipo = $('<select />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'tipo_refer[]', 'id': `tipo_refer_${index_referencia}`}).append(referencias);
    if(tipo_refer_val) tipo.val(tipo_refer_val);

    let empresa = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'empresa[]', 'id': `empresa_${index_referencia}`, 'value': empresa_val});

    let contacto = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'contacto[]', 'id': `contacto_${index_referencia}`, 'value': contacto_val});

    let telefono = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'telefono_refer[]', 'id': `telefono_refer_${index_referencia}`, 'value': telefono_refer_val});

    let afinidad = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'afinidad[]', 'id': `afinidad_${index_referencia}`, 'value': afinidad_val});

    let inicio_laboral = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'inicio_labor_refer[]', 'id': `inicio_labor_refer_${index_referencia}`, 'value': inicio_labor_refer_val});

    let fin_laboral = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'fin_labor_refer[]', 'id': `fin_labor_refer_${index_referencia}`, 'value': fin_labor_refer_val});

    let cargo = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'cargo_refer[]', 'id': `cargo_refer_${index_referencia}`, 'value': cargo_refer_val});

    let razon_separacion = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'razon_separacion[]', 'id': `razon_separacion_${index_referencia}`, 'value': razon_separacion_val});
  ...
  if(old_refs != []){
    old_refs.map(item => {
      console.log(item);
      add_referencia(item.tipo_refer, item.empresa, item.contacto, item.telefono_refer, item.afinidad, item.inicio_labor_refer, item.fin_labor_refer, item.cargo_refer, item.razon_separacion);
    });
  }
  ...
  const add_dotacion = (entrega_val, dotacion_id_val) => {
    ...
    let entrega = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'entrega[]', 'id': `entrega_${index_dotacion}`, 'value': entrega_val});

    let articulo = $('<select />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'dotacion_id[]', 'id': `dotacion_id_${index_dotacion}`}).append(articulos);
  ...
  const add_familia = (relacion_val=null, nombre_fam_val=null, fecha_nacimiento_fam_val=null, ocupacion_val=null, telefono_fam_val=null, celular_fam_val=null) => {
    let table = $('#table-familia > tbody');

    let button = $('<i />', {'type': 'button', 'class':'fas fa-times removeRow', 'name': 'remove', 'id': `familia-${index_familia}`});

    let relacion = $('<select />', {'type': 'number', 'class': 'form-control form-control-sm', 'name': 'relacion[]', 'id': `relacion_${index_familia}`}).append(relaciones);
    if(relacion_val) relacion.val(relacion_val);

    let nombre = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'nombre_fam[]', 'id': `nombre_fam_${index_familia}`, 'value': nombre_fam_val});

    let fecha_nacimiento = $('<input />', {'type': 'date', 'class': 'form-control form-control-sm', 'name': 'fecha_nacimiento_fam[]', 'id': `fecha_nacimiento_fam_${index_familia}`, 'value': fecha_nacimiento_fam_val});

    let ocupacion = $('<input />', {'type': 'text', 'class': 'form-control form-control-sm', 'name': 'ocupacion[]', 'id': `ocupacion_${index_familia}`, 'value': ocupacion_val});

    let telefono = $('<input />', {'type': 'number', 'class': 'form-control form-control-sm', 'name': 'telefono_fam[]', 'id': `telefono_fam_${index_familia}`, 'max': '9999999', 'value': telefono_fam_val});

    let celular = $('<input />', {'type': 'number', 'class': 'form-control form-control-sm', 'name': 'celular_fam[]', 'id': `celular_fam_${index_familia}`, 'max': '0999999999', 'value': celular_fam_val});
