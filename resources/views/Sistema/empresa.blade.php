...
@section('desktop-content')
  ...
  <x-path :items="[ ['text' => 'Empresa', 'current' => true, 'href' => '#'] ]" />

  <x-blue-board title='Datos de la empresa'
    :foot="[ ['text'=>'Guardar', 'href'=>'#', 'id'=>'formSubmit', 'tipo'=>'link'] ]">
    @if ($empresa->id)
    ...
    <div class="form-row">
      <div class="form-group col-6 col-md-2">
        ...
        <input type="text" name="nombre" id="nombre"
          ...
          value="{{ old('nombre', $empresa->nombre) ?? Auth::user()->empresa->nombre }}">
      </div>
      <div class="form-group col-6 col-md-2">
        <label for="representante">Representante</label>
        <input type="text" name="representante" id="representante"
          class="form-control form-control-sm @error('representante') is-invalid @enderror"
          value="{{ old('representante', $empresa->representante) }}">
      </div>
      <div class="form-group col-12 col-md-2">
        <label for="ruc">RUC</label>
        <input type="text" minlength="13" maxlength="13" pattern="[0-9]{13}" name="ruc" id="ruc"
          class="form-control form-control-sm @error('ruc') is-invalid @enderror"
          value="{{ old('ruc', $empresa->ruc) ?? Auth::user()->empresa->id }}">
      </div>
      <div class="form-group col-6 col-md-2">
        <label for="telefono">Teléfono</label>
        <input type="text" minlength="7" maxlength="7" pattern="[0-9]{7}" name="telefono" id="telefono"
          class="form-control form-control-sm @error('telefono') is-invalid @enderror"
          value="{{ old('telefono', $empresa->telefono) }}">
      </div>
      <div class="form-group col-6 col-md-2">
        <label for="celular">Celular</label>
        <input type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" name="celular" id="celular"
      ...
      <div class="form-group col-12 col-md-4">
        ...
        <input type="url" name="web" id="web" class="form-control form-control-sm @error('web') is-invalid @enderror"
      ...
      <div class="form-group col-4 col-md-2">
        ...
        <input type="number" min="0" max="9999999" name="inicio" id="inicio"
          class="form-control form-control-sm @error('inicio') is-invalid @enderror"
          value="{{ old('inicio', $empresa->inicio) }}">
      </div>
      {{-- <div class="form-group col-4 col-md-2">
      ...
      <div class="form-group col-12 col-md-4">
        ...
        <input type="url" name="cloud" id="cloud"
          class="form-control form-control-sm @error('cloud') is-invalid @enderror"
          value="{{ old('cloud', $empresa->cloud) }}">
      </div>
      <div class="form-group col-12 col-md-4">
        <label for="mail">Cliente de email</label>
        <input type="url" name="mail" id="mail" class="form-control form-control-sm @error('mail') is-invalid @enderror"
          value="{{ old('mail', $empresa->mail) }}">
      </div>
    </div>
    </form>
  </x-blue-board>

  <x-blue-board title='Centro de Costos'
    :foot="[ ['text'=>'Nuevo', 'href'=>'#modalCCostos', 'id'=>'newCCostos', 'tipo'=>'modal'] ]">
    <div class="row">
