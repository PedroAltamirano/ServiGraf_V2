...
@section('desktop-content')
  <x-path
    :items="[ ['text' => 'Usuarios', 'current' => false, 'href' => route('usuarios')], ['text' => $text, 'current' => true, 'href' => $path] ]" />
    ...
    <form action="{{ $path }}" method="POST" id="form">
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-6">
          ...
          <select class="custom-select @error('cedula') is-invalid @enderror" name="cedula" id="cedula"
            {{ session('current.cedula') ? 'disabled' : '' }}>
        ...
        <div class="form-group col-12 col-md-6">
          ...
          <input type="text" name="usuario" id="usuario" class="form-control @error('usuario') is-invalid @enderror"
            placeholder="Usuario" value="{{ old('usuario', $usuario->usuario) }}">
        </div>
        <div class="form-group col-12 col-md-6">
          <label for="password">Contraseña</label>
          <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password"
            placeholder="Contraseña" value="{{ old('password') }}" {{ isset($usuario->password) ? 'disabled' : '' }}>
        </div>
        <div class="form-group col-12 col-md-6">
          <label for="password_confirmation">Verificar contraseña</label>
          <input type="password" class="form-control  @error('passwordVer') is-invalid @enderror"
            name="password_confirmation" id="password_confirmation" placeholder="Contraseña"
        ...
        <div class="form-group col-6 col-md-4">
          ...
          <select class="custom-select select2Class @error('procesos') is-invalid @enderror" name="procesos[]"
            id="procesos" multiple>
        ...
        <div class="form-group col-6 col-md-4">
          ...
          <select class="custom-select select2Class @error('actividades') is-invalid @enderror" name="actividades[]"
            id="actividades" disabled multiple>
            <option disabled>Select one</option>
            @php
        ...
        <div class="form-group col-6 col-md-4">
          ...
          <select class="custom-select select2Class @error('clientes') is-invalid @enderror" name="clientes[]"
            id="clientes" multiple>
            <option disabled>Select one</option>
            @php
        ...
        <div class="form-group col-3 col-md-2">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="statusDiv">
            <input type="checkbox" class="custom-control-input @error('status') is-invalid @enderror" id="status"
              name="status" {{ old('status', $usuario->status) == '1' ? 'checked' : '' }} value='1'>
        ...
        <div class="form-group col-3 col-md-2">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="utilidadDiv">
            <input type="checkbox" class="custom-control-input @error('utilidad') is-invalid @enderror" id="utilidad"
              name="utilidad" {{ old('utilidad', $usuario->utilidad) == '1' ? 'checked' : '' }} value='1'>
        ...
        <div class="form-group col-3 col-md-2">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="reservarotDiv">
            <input type="checkbox" class="custom-control-input @error('reservarot') is-invalid @enderror" id="reservarot"
              name="reservarot" {{ old('reservarot', $usuario->reservarot) == '1' ? 'checked' : '' }} value='1'>
        ...
        <div class="form-group col-3 col-md-2">
          ...
          <div class="custom-control custom-switch d-flex justify-content-center" name="libroDiv">
            <input type="checkbox" class="custom-control-input @error('libro') is-invalid @enderror" id="libro"
              name="libro" {{ old('libro', $usuario->libro) == '1' ? 'checked' : '' }} value='1'>
