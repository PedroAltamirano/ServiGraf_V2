...
@section('home-content')
  <div class="jumbotron jumbotron-fluid text-center" id="fondo"
    style="margin: 0px;font-family: ABeeZee, sans-serif;color: rgb(255,255,255);background-image: url(&quot;{{ asset('img/imprenta_fondo1.jpeg') }}&quot;);padding: 0px;">
    <div class="text-center" id="img_overlay"
      style="background-color: rgba(0, 0, 0, 0.4);opacity: 1;width: 100%;height: 100%;">
  ...
  <div class="container-fluid mx-auto maximum-width" style="font-family: ABeeZee, sans-serif;">
    <div class="row" style="color: grey;">
      ...
      <div class="col-12 col-md-6 pl-lg-5 mb-3 mb-md-0">
        ...
        <div class="mt-4">
          <p><i class="far fa-clock"></i>&nbsp;Atención de Lunes a Viernes de:<br>&nbsp; &nbsp; &nbsp;9:00 a 13:00 &amp;
            14:00 a 18:00</p>
          ...
          <p><i class="far fa-money-bill-alt"></i>&nbsp;Efectivo &nbsp;&nbsp;<i
              class="fas fa-university"></i>&nbsp;Transferencias &nbsp;&nbsp;<i class="fab fa-paypal"></i>&nbsp;Pay Pal
          </p>
          <p><i class="fab fa-facebook"></i>&nbsp;<a href="https://www.facebook.com/ServiGraf-281911858984024/"
              target="_blank" class="no-decoration">Visítanos en facebook</a></p>
        </div>
      </div>
      <div class="col-12"><iframe allowfullscreen="" frameborder="0" width="100%" height="400"
          src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDqHSgc2vnoWJPoVCHbEMOn--i_T4C7Kpc&amp;q=Uruguay+N16-66+yrio+de+janeiro&amp;zoom=19"></iframe>
      </div>
    </div>
  </div>
@endsection
