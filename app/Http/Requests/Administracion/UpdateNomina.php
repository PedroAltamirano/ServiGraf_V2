...
class UpdateNomina extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'inicio_labor_refer.*' => ['nullable', 'required_if:tipo_refer.*,2', 'date'],
      'fin_labor_refer.*' => ['nullable', 'required_if:tipo_refer.*,2', 'date'],
      'cargo_refer.*' => ['nullable', 'required_if:tipo_refer.*,2', 'string', 'max:50'],
      'razon_separacion.*' => ['nullable', 'required_if:tipo_refer.*,2', 'string', 'max:250'],
